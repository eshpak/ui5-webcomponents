...
<ui5-table
	...
	growing-button-subtext="${ args['growingButtonSubtext'] }" 
	growing-button-text="${ args['growingButtonText'] }" 
	?hideNoData="${ args['hideNoData'] }" 
	mode="${ args['mode'] }" 
	no-data-text="${ args['noDataText'] }" 
	?stickyColumnHeader="${ args['stickyColumnHeader'] }" 
>
...
};const TableinSingleSelectmodeTemplate = () => {
	
return html`
<div class="snippet flex-column">		<ui5-table class="demo-table" id="singleSelectTbl" mode="SingleSelect">			<!-- Columns -->			<ui5-table-column slot="columns">				<span>Product</span>			</ui5-table-column>			<ui5-table-column slot="columns" min-width="600" popin-text="Supplier" demand-popin>				<span>Supplier</span>			</ui5-table-column>			<ui5-table-column slot="columns" min-width="800" popin-text="Dimensions" demand-popin>				<span>Dimensions</span>			</ui5-table-column>			<ui5-table-column slot="columns" min-width="800" popin-text="Weight" demand-popin>				<span>Weight</span>			</ui5-table-column>			<ui5-table-column slot="columns">				<span>Price</span>			</ui5-table-column>		</ui5-table>	</div>
${ 
  (function () { setTimeout(function () { 
		// Growing Table
		var products2 = {
...
export const TableinSingleSelectmode = TableinSingleSelectmodeTemplate.bind({});

TableinSingleSelectmode.storyName = `Table in SingleSelect mode`;
TableinSingleSelectmode.parameters = {
  controls: {
		disabled: true,
	}
};const TableinMultiSelectmodeTemplate = () => {
	
return html`
<div class="snippet flex-column">		<ui5-table class="demo-table" id="multiSelectTbl" mode="MultiSelect">			<!-- Columns -->			<ui5-table-column slot="columns">				<span>Product</span>			</ui5-table-column>			<ui5-table-column slot="columns" min-width="600" popin-text="Supplier" demand-popin>				<span>Supplier</span>			</ui5-table-column>			<ui5-table-column slot="columns" min-width="800" popin-text="Dimensions" demand-popin>				<span>Dimensions</span>			</ui5-table-column>			<ui5-table-column slot="columns" min-width="800" popin-text="Weight" demand-popin>				<span>Weight</span>			</ui5-table-column>			<ui5-table-column slot="columns">				<span>Price</span>			</ui5-table-column>		</ui5-table>	</div>
${ 
  (function () { setTimeout(function () { 
...
export const TableinMultiSelectmode = TableinMultiSelectmodeTemplate.bind({});

TableinMultiSelectmode.storyName = `Table in MultiSelect mode`;
TableinMultiSelectmode.parameters = {
  controls: {
		disabled: true,
	}
};const TablewithNoDataTemplate = () => {
	
return html`
<div class="snippet flex-column">			<ui5-table class="demo-table" no-data-text="No Data">				<!-- Columns -->				<ui5-table-column slot="columns" style="width: 12rem">					<span style="line-height: 1.4rem">Product</span>				</ui5-table-column>				<ui5-table-column slot="columns" min-width="800" popin-text="Supplier">					<span style="line-height: 1.4rem">Supplier</span>				</ui5-table-column>				<ui5-table-column slot="columns" min-width="600" popin-text="Dimensions" demand-popin>					<span style="line-height: 1.4rem">Dimensions</span>				</ui5-table-column>				<ui5-table-column slot="columns" min-width="600" popin-text="Weight" demand-popin>					<span style="line-height: 1.4rem">Weight</span>				</ui5-table-column>				<ui5-table-column slot="columns">					<span style="line-height: 1.4rem">Price</span>				</ui5-table-column>			</ui5-table>		</div>
${ 
  (function () { setTimeout(function () { 
		// Growing Table
		var products3 = {
...
export const TablewithNoData = TablewithNoDataTemplate.bind({});

TablewithNoData.storyName = `Table with No Data`;
TablewithNoData.parameters = {
  controls: {
		disabled: true,
	}
};const GrowingTablewithMorebuttonTemplate = () => {
	
return html`
<div class="snippet">		<ui5-table id="myTbl" growing="Button" growing-button-subtext="[4 / 12]">			<ui5-table-column id="column-1" slot="columns" width="350px">				<ui5-label>Product</ui5-label>			</ui5-table-column>			<ui5-table-column id="column-2" slot="columns" min-width="800" popin-text="Supplier">				<ui5-label>Supplier</ui5-label>			</ui5-table-column>			<ui5-table-column id="column-3" slot="columns" min-width="600" popin-text="Dimensions" demand-popin>				<div class="column-content">					<ui5-label>Dimensions</ui5-label>				</div>			</ui5-table-column>			<ui5-table-column id="column-4" slot="columns" min-width="600" popin-text="Weight" demand-popin>				<ui5-label>Weight</ui5-label>			</ui5-table-column>			<ui5-table-column id="column-5" slot="columns">				<ui5-label>Price</ui5-label>			</ui5-table-column>		</ui5-table>	</div>
${ 
  (function () { setTimeout(function () {  }, 500) })()
}`;
}

export const GrowingTablewithMorebutton = GrowingTablewithMorebuttonTemplate.bind({});

GrowingTablewithMorebutton.storyName = `Growing Table with "More" button`;
GrowingTablewithMorebutton.parameters = {
  controls: {
		disabled: true,
	}
};const GrowingTableonScrollTemplate = () => {
	
return html`
<div class="snippet">		<ui5-table id="myTblOnScroll" growing="Scroll">			<ui5-table-column id="column-1" slot="columns" width="350px">				<ui5-label>Product</ui5-label>			</ui5-table-column>			<ui5-table-column id="column-2" slot="columns" min-width="800" popin-text="Supplier">				<ui5-label>Supplier</ui5-label>			</ui5-table-column>			<ui5-table-column id="column-3" slot="columns" min-width="600" popin-text="Dimensions" demand-popin>				<div class="column-content">					<ui5-label>Dimensions</ui5-label>				</div>			</ui5-table-column>			<ui5-table-column id="column-4" slot="columns" min-width="600" popin-text="Weight" demand-popin>				<ui5-label>Weight</ui5-label>			</ui5-table-column>			<ui5-table-column id="column-5" slot="columns">				<ui5-label>Price</ui5-label>			</ui5-table-column>		</ui5-table>	</div>
${ 
  (function () { setTimeout(function () {  }, 500) })()
}`;
}

export const GrowingTableonScroll = GrowingTableonScrollTemplate.bind({});

GrowingTableonScroll.storyName = `Growing Table on Scroll`;
GrowingTableonScroll.parameters = {
  controls: {
		disabled: true,
	}
};const TablewithgroupingSingleSelectTemplate = () => {
	
return html`
<div class="snippet flex-column">		<!-- Header -->		<div class="header">			<span>The <em>ui5-table-group-row</em> allows visual grouping of the table rows.</span>		</div>		<ui5-table class="demo-table-single" mode="SingleSelect">			<ui5-table-column id="column-1" slot="columns">				<ui5-label>City</ui5-label>			</ui5-table-column>			<ui5-table-column id="column-2" slot="columns" min-width="500" popin-text="Supplier" demand-popin>				<ui5-label>Supplier</ui5-label>			</ui5-table-column>			<ui5-table-column id="column-3" slot="columns" min-width="500">				<ui5-label>Country</ui5-label>			</ui5-table-column>			<ui5-table-group-row>Country: Bulgaria</ui5-table-group-row>			<ui5-table-row>				<ui5-table-cell><span>Sofia</span></ui5-table-cell>				<ui5-table-cell><span>Company 1</span></ui5-table-cell>				<ui5-table-cell><span>Bulgaria</span></ui5-table-cell>			</ui5-table-row>			<ui5-table-row>				<ui5-table-cell><span>Plovdiv</span></ui5-table-cell>				<ui5-table-cell><span>Company 2</span></ui5-table-cell>				<ui5-table-cell><span>Bulgaria</span></ui5-table-cell>			</ui5-table-row>			<ui5-table-group-row><span>Country: USA</span></ui5-table-group-row>			<ui5-table-row>				<ui5-table-cell><span>Denver</span></ui5-table-cell>				<ui5-table-cell><span>Company 3</span></ui5-table-cell>				<ui5-table-cell><span>USA</span></ui5-table-cell>			</ui5-table-row>			<ui5-table-row>				<ui5-table-cell><span>Boston</span></ui5-table-cell>				<ui5-table-cell><span>Company 4</span></ui5-table-cell>				<ui5-table-cell><span>USA</span></ui5-table-cell>			</ui5-table-row>		</ui5-table>	</div>
${ 
  (function () { setTimeout(function () {  }, 500) })()
}`;
}

export const TablewithgroupingSingleSelect = TablewithgroupingSingleSelectTemplate.bind({});

TablewithgroupingSingleSelect.storyName = `Table with grouping (SingleSelect)`;
TablewithgroupingSingleSelect.parameters = {
  controls: {
		disabled: true,
	}
};const TableswithgroupingMultiSelectTemplate = () => {
	
return html`
<div class="snippet flex-column">		<ui5-table class="demo-table-multi" mode="MultiSelect">			<ui5-table-column id="column-1" slot="columns">				<ui5-label>City</ui5-label>			</ui5-table-column>			<ui5-table-column id="column-2" slot="columns" min-width="500" popin-text="Supplier" demand-popin>				<ui5-label>Supplier</ui5-label>			</ui5-table-column>			<ui5-table-column id="column-3" slot="columns" min-width="500">				<ui5-label>Country</ui5-label>			</ui5-table-column>			<ui5-table-group-row>Country: Bulgaria</ui5-table-group-row>			<ui5-table-row>				<ui5-table-cell><span>Sofia</span></ui5-table-cell>				<ui5-table-cell><span>Company 1</span></ui5-table-cell>				<ui5-table-cell><span>Bulgaria</span></ui5-table-cell>			</ui5-table-row>			<ui5-table-row>				<ui5-table-cell><span>Plovdiv</span></ui5-table-cell>				<ui5-table-cell><span>Company 2</span></ui5-table-cell>				<ui5-table-cell><span>Bulgaria</span></ui5-table-cell>			</ui5-table-row>			<ui5-table-group-row><span>Country: USA</span></ui5-table-group-row>			<ui5-table-row>				<ui5-table-cell><span>Denver</span></ui5-table-cell>				<ui5-table-cell><span>Company 3</span></ui5-table-cell>				<ui5-table-cell><span>USA</span></ui5-table-cell>			</ui5-table-row>			<ui5-table-row>				<ui5-table-cell><span>Boston</span></ui5-table-cell>				<ui5-table-cell><span>Company 4</span></ui5-table-cell>				<ui5-table-cell><span>USA</span></ui5-table-cell>			</ui5-table-row>		</ui5-table>	</div>
${ 
  (function () { setTimeout(function () {  }, 500) })()
}`;
}

export const TableswithgroupingMultiSelect = TableswithgroupingMultiSelectTemplate.bind({});

TableswithgroupingMultiSelect.storyName = `Tables with grouping (MultiSelect)`;
TableswithgroupingMultiSelect.parameters = {
  controls: {
		disabled: true,
	}
};
